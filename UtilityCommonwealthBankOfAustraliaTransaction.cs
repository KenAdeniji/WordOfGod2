...
namespace WordEngineering
{
 ...
 public class UtilityCommonwealthBankOfAustraliaTransaction
 {
  ...
  public const string SQLInsert = "IF NOT EXISTS ( SELECT 1 FROM Commonwealth WHERE Dated = '{0}' AND DebitCredit = {1} AND TransactionDescription = '{2}' AND Balance = {3} ) INSERT Commonwealth( Dated,  DebitCredit, TransactionDescription, Balance ) " +
                                  "VALUES ( '{0}', {1}, '{2}', {3} )";
