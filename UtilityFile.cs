...
namespace WordEngineering
{
 ...
 public class UtilityFile
 {
  ...
  ///<summary>DateAppend</summary>
  public static string DateAppend(string filename)
  {
   return(DateAppend(filename, true));
  }
  
  ///<summary>DateAppend</summary>
  public static string DateAppend(string filename, bool isPrepend)
  {
   String        directory;
   StringBuilder sbFilename;
   sbFilename = new StringBuilder();
