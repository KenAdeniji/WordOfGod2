...
namespace WordEngineering
{
    ...
    public class UtilityNetworkInformation
    {
        ...
        public static void NetworkInformationStub()
        {
            ...
            System.Console.WriteLine("Domain name: {0}", ipGlobalProperties.DomainName);
            ...
            foreach ( NetworkInterface networkInterface in NetworkInterface.GetAllNetworkInterfaces() )
            {
                ...
                //http://blogs.msdn.com/dgorti/archive/2005/10/04/477078.aspx Getting SubnetMask through System.Net.NetworkInformation 
