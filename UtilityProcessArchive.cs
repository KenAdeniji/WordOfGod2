...
namespace WordEngineering
{
    ...
    public class UtilityProcess
    {
        ...
        public static void UpTime() { ProcessStart(); }
        ...
        /// <summary>WinPop.exe: POP3 Service administration utility. WinPop Add domain, for example, WinPop Add localhost.</summary>
        ...
        /// <summary>WinPop.exe: POP3 Service administration utility. WinPop Add mailbox@domain, for example, WinPop Add administrator@localhost.</summary>
